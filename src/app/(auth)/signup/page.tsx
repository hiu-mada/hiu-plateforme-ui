  ...
  return (
    <>
      <div className="signUpWrapper">
        <div className="formWrapper bg-blue-950">
          <div className="left px-5 py-4">
            <h3 className="title"> Welcome Back! </h3>
            <h5>To keep connected with us, </h5>
              <p> Please login with your personal information</p>
            <Link href ={"/login"}>
              <Button className="border-blue-950 text-stone-300 hover:border-blue-800 hover:text-black hover:bg-white transition-colors border rounded-full px-8">Log In</Button>
            </Link>
          ...
          <div className="rigth bg-white px-4 py-6">
