      ...
      <div className="logInWrapper">
        ...
        <div className="rigth bg-white px-4 py-6">
          ...
          <div className="left px-5 py-4">
            ...
            <Link href ={"/signup"}>
              <Button className="border-blue-950 text-stone-300 hover:border-blue-800 hover:text-black hover:bg-white transition-colors border rounded-full px-8">Sign Up</Button>
            </Link>
