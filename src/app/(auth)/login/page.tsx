  ...
  return (
    <>
      <div className="logInWrapper">
        ...
        <div className="rigth bg-white px-4 py-6 dark:bg-blue-950">
            ...
            <p className="text-center">or enter your information </p>
            <Form { ... form}>
